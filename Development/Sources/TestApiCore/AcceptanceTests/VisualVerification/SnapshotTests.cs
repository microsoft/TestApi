...
namespace Microsoft.Test.AcceptanceTests.VisualVerification
{
    public class SnapshotTests
    {
        ...
        [Theory]
        [InlineData(@"Images\largerImage.png", @"Images\smallerImage.png",@"1 2,10 4,19 2,29 5")]
        ...
        [Theory]
        [InlineData(@"Images\largerImage.png", @"Images\smallerImageSlightDifferences.png", @"1 2,10 4,19 2,29 5")]
