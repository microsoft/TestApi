...
namespace Microsoft.Test.AcceptanceTests.VisualVerification
{
    ...
    {
        [Theory]
        [InlineData(@".\VisualVerification\Images\Black468x304.bmp", 255, 0, 0, 0, 468, 304)]
        [InlineData(@".\VisualVerification\Images\Black468x304.gif", 255, 0, 0, 0, 468, 304)]
        [InlineData(@".\VisualVerification\Images\Black468x304.jpg", 255, 0, 0, 0, 468, 304)]
        [InlineData(@".\VisualVerification\Images\Black468x304.png", 255, 0, 0, 0, 468, 304)]
        [InlineData(@".\VisualVerification\Images\White468x304.jpg", 255, 255, 255, 255, 468, 304)]
        [InlineData(@".\VisualVerification\Images\White468x304.png", 255, 255, 255, 255, 468, 304)]
        ...
        [Theory]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 100, 100, 20, 50)]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 0, 0, 1, 1)]
        ...
        [Theory]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 10, 100)]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 10, 1000)]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 500, 1000)]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 1, 1)]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", 0, 0)]
        ...
        [Theory]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", @".\VisualVerification\Images\Red468x304.png")]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", @".\VisualVerification\Images\Black468x304.png")]
        [InlineData(@".\VisualVerification\Images\Red468x304.png", @".\VisualVerification\Images\White468x304.png")]
        ...
        [Theory]
        [InlineData(@".\VisualVerification\Images\largerImage.png", @".\VisualVerification\Images\smallerImage.png", @"1 2,10 4,19 2,29 5")]
        public void FindSubImage(string fileNameImage, string fileNameSubImage, string pointListStringIn)
        {
            Snapshot image = Snapshot.FromFile(fileNameImage);
            Snapshot subimage = Snapshot.FromFile(fileNameSubImage);
            string[] pointListString = pointListStringIn.Split(',');
            List<Rectangle> points = new List<Rectangle>();
            foreach (string pointString in pointListString)
            {
            ...
            {
                Assert.Contains<Rectangle>(rect, rects);
            }

            Assert.Equal(rects.Count, points.Count);
        }

        [Theory]
        [InlineData(@".\VisualVerification\Images\largerImage.png", @".\VisualVerification\Images\smallerImageSlightDifferences.png", @"1 2,10 4,19 2,29 5")]
        public void FindSubImageWithVerifier(string fileNameImage, string fileNameSubImage, string pointListStringIn)
        {
            Snapshot image = Snapshot.FromFile(fileNameImage);
            Snapshot subimage = Snapshot.FromFile(fileNameSubImage);
            string[] pointListString = pointListStringIn.Split(',');
            ...
            // Smaller image for this test has a visible green tint. This verifier will allow for this color difference.
            Collection<Rectangle> rects = image.Find(subimage, new SnapshotColorVerifier(new Color(), new ColorDifference(255,0,100,0)));
            foreach (Rectangle rect in points)
            {
                Assert.Contains<Rectangle>(rect, rects);
            }
