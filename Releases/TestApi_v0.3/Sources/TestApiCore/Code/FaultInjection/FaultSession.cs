...
namespace Microsoft.Test.FaultInjection
{
    ...
    /// </remarks>
    /// 
    /// <example>The following example creates a new FaultSession with a single FaultRule and launches the application under test.
    /// <code>
    /**
    ...
    */
    ...
    /// </example>
    /// 
    /// <example>The following example creates a new FaultSession with multiple FaultRules and launches the application under test.
    /// <code>
    /**
            string sampleAppPath = "SampleApp.exe";
