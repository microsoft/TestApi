...
namespace Microsoft.Test.LeakDetection
{
    ...
    public class MemorySnapshot
    {
        ...
        public static MemorySnapshot FromProcess(int processId)
        {
            ...
            MemoryInterop.PROCESS_MEMORY_COUNTERS_EX counters = MemoryInterop.GetCounters(process.Handle);
            
            // Populate memory statistics.
            memorySnapshot.GdiObjectCount = MemoryInterop.GetGuiResources(process.Handle, MemoryInterop.GR_GDIOBJECTS);
            ...
            memorySnapshot.UserObjectCount = MemoryInterop.GetGuiResources(process.Handle, MemoryInterop.GR_USEROBJECTS); 
            ...
            memorySnapshot.WorkingSetPrivateBytes = process.PrivateMemorySize64;            
        ...
        /// For more information see <seealso cref="WorkingSetBytes"/>. 
        /// </summary>
        ///
        /// <remarks>
        /// <p> This metric is reported as follows by the other tools: </p> 
