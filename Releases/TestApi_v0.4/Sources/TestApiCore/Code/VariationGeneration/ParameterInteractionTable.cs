...
namespace Microsoft.Test.VariationGeneration
{
    ...
    internal class ParameterInteractionTable
    {
        ...
        List<Constraint> completeConstraints = new List<Constraint>();
        ...
        private void GenerateInteractionsForConstraints(Model model, int order)
        {
            ...
            completeConstraints.Add(new TaggedValueConstraint());
        ...
        private void GenerateHigherOrderDependentExclusions(Model model, int order, List<int> parameterInteractionCounts, ParameterInteraction completeInteraction, IEnumerable<ValueCombination> allowedCombinations)
        {
