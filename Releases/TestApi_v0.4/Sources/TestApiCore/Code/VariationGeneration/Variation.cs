...
namespace Microsoft.Test.VariationGeneration
{
    ...
    public class Variation : Dictionary<string, object>
    {
        ...
        /// <summary>
        /// Initializes a new Variation with the specified expected result.
        /// </summary>
        /// <param name="tag">Whether this variation contains a user defined tag.</param>
        ...
        /// <summary>
        /// Indicates if one of the values has been tagged with an expected result.  The default is null.
        /// </summary>
