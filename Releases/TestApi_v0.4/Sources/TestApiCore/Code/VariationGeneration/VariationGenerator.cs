...
namespace Microsoft.Test.VariationGeneration
{
    ...
    internal static class VariationGenerator
    {
        ...
        private static IList<VariationIndexTagPair> GenerateVariationIndices(ParameterInteractionTable interactions, int variationSize, int seed, long maxVariations, object defaultTag)
        {
