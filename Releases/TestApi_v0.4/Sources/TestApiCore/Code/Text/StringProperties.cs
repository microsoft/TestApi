...
namespace Microsoft.Test.Text
{
    ...
    /// </remarks>
    ///
    /// <example>The following example demonstrates how to create a random string with 10 Unicode points
    ...
    public class StringProperties
    {
        ...
        /// <summary>
        /// Determines whether the string belongs to a particular <see cref="UnicodeRange"/>.
        /// </summary>
