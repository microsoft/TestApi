...
namespace Microsoft.Test.VisualVerification
{
    ...
    /// <p/>
    /// For more information on histograms, refer to the description of the Histogram class.
    /// </summary>
    ///
    /// <example>Takes a snapshot and verifies it is an absolute match to an expected image.
    /// <code>
    /**
        // Take a snapshot, compare to a master image, validate match using a tolerance histogram 
